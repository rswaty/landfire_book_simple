...
<!--SH comment: It would be good if the goals flowed in the order of the workbook pages as in Happy Git with R. We can adjust that as the website structure takes place-->
...
<!--SH suggests creating a subpage on "Stuff that can go wrong when installing SyncroSim" or something like that-->
